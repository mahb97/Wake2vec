## Llama 3.2-1B P2 session 6 (resuming from step 1500)

gap crossed 1.0 last time (train 3.22, val 4.25), overfitting but building LoRA depth for P3.
