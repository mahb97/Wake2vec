...
## Qwen 2.5-14B P1 session 14 (resuming from step 960)

fourteen sessions: val was 17.18 at step 900 and still dropping with 2,040 steps to go.

Resuming from `sentry_step_0960.pt` with `STEP_OFFSET=960`.
...
| Run 13 | 0–80 | 880–960 | sentry@960 |
| Run 14 | 0–? | 960–? | *today* |
...
old but gold: [Stargirl](https://soundcloud.com/theweeknd/stargirl-interlude-1?si=362f203ced0e4c9cac6e47a41a11ff89&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing)
