# -*- coding: utf-8 -*-
"""Wake2Vec: mistralai/Mistral-7B-v0.3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13wXxR7W_ACH9013_v8MaFx-wqpQ8jUnO
...
# Align libs without touching torch
!pip -q install -U transformers==4.45.2 accelerate==0.34.2 datasets==3.0.1 bitsandbytes==0.44.1 fsspec==2025.3.0 gcsfs==2025.3.0 --progress-bar off

# (Optional) if bitsandbytes yells about CUDA setup
!pip -q install -U bitsandbytes-cuda120

from huggingface_hub import login
from getpass import getpass

HF_TOKEN = getpass("Paste your HF token (hidden): ")
login(token=HF_TOKEN, add_to_git_credential=True)  # authenticates for this session
